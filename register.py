...
class Register:
    def __init__(self,root):
        ...
        dep_combo=ttk.Combobox(current_course_frame,textvariable=self.var_dep,font=("times new roman",15,"bold"),state="readonly",width=20)
        ...
        year_combo=ttk.Combobox(current_course_frame,textvariable=self.var_year,font=("times new roman",15,"bold"),state="readonly",width=20)
        ...
        semester_combo=ttk.Combobox(current_course_frame,textvariable=self.var_semester,font=("times new roman",15,"bold"),state="readonly",width=20)
        ...
        div_combo=ttk.Combobox(class_Student_frame,textvariable=self.var_div,font=("times new roman",15,"bold"),state="readonly",width=20)
    ...
    def delete_data(self):
        if self.var_std_id.get()=="":
            ...
            try:
                delete = messagebox.askyesno("Student Details Delete","Do you want to delete details of this student?",parent=self.root)
                if delete>0:
                    conn=mysql.connector.connect(host="localhost",user="root",password="8302123277",database="face_recognizer")
                    my_cursor= conn.cursor()
    ...
    # *********reset function*******
    def reset_data(self):
        self.var_dep.set("Select Depatment")
